...
public class Map {
    ...
    private static Map initialiseMap() {
		Map carte = new Map();
		Soldier s = new Soldier(9, 9, 0, Player.getPlayerList(0), carte);
		Soldier s2 = new Soldier(9, 9, 0, Player.getPlayerList(1), carte);
		Soldier s3 = new Soldier(9, 9, 0, Player.getPlayerList(2), carte);
		Soldier s4 = new Soldier(9, 9, 0, Player.getPlayerList(3), carte);
