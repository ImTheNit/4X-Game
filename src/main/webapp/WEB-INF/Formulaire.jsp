...
<body>
<div class="log-fom">
  <h2>GET method to Matrice</h2>
  <form action="MatriceServlet3" method="GET">
    <input type="number" name="x" placeholder="x" />
    <input type="number" name="y" placeholder="y" />
    <button type="submit" class="btn">Matrice</button>
  </form>
</div><!--end form -->


<div class="log-fom">
  <h2>POST method to Matrice</h2>
  <form action="MatriceServlet3" method="POST">
    <input type="number" name="x" placeholder="x" />
    <input type="number" name="y" placeholder="y" />
